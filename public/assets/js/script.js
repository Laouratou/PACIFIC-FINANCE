...
function handleScroll() {
	const images = document.querySelectorAll('.image'); // Sélectionner toutes les images

	images.forEach((image) => {
		if (isElementInViewport(image)) {
			image.classList.add('visible'); // Ajouter la classe 'visible' si l'image est dans le viewport
		}
	});
}
