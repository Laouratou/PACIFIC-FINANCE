                ...
                <div class="content_block_three">
                    <div class="content-box mr_110">
                        ...
                        <div class="text-box mb_40">
                            <h2>Crédit entrepreneurs et commerçants</h2>
                        </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                            <div class="content_block_four">
                                <div class="content-box mr_110">
                                    <h6>Vous êtes un entrepreneur ou un commerçant ?</h6>
                                   ...
                                   {{-- <br> --}}
                                    <ul class="list-item mb_40 clearfix">
                                        ...
                                        <li>Crédit équipement </li>
                                        <li>Construction et aménagement locative</li>
                ...
                <div class="tab" id="tab-2">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="image-box ml_40">
                                <div class="image-shape" style="background-image: url(assets/images/shape/shape-3.png);"></div>
                                <figure class="image"><img src="assets/images/resource/MODALITE (1).jpg" alt=""style="width:400px;height:400px;object-fit:cover;"></figure>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="tab" id="tab-3">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="image-box ml_40">
                                <div class="image-shape" style="background-image: url(assets/images/shape/shape-3.png);"></div>
                                <figure class="image"><img src="assets/images/resource/Laouratou.jpg" alt=""style="width:400px;height:400px;object-fit:cover;"></figure>
                            </div>
                        </div>
                    </div>
                </div>
