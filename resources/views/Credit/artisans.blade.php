                ...
                <div class="tab" id="tab-2">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="image-box ml_40">
                                <div class="image-shape" style="background-image: url(assets/images/shape/shape-3.png);"></div>
                                <figure class="image"><img src="assets/images/resource/CONDITIONS.jpg" alt=""style="width:400px;height:400px;object-fit:cover;"></figure>
                            </div>
                        </div>
                    </div>
                </div>
