                    ...
                    <div class="image-box">
                        <div class="image-shape">
                            ...
                            <figure class="image pt_115 d-none d-lg-block">
                                <img src="assets/images/resource/entreprise.jpg" alt="" style="width:500px;height:500px;object-fit:cover;border-radius: 50%;">
                            </figure>

                            {{-- Petit écran (mobile) : image responsive et carrée pour garder la forme circulaire --}}
                            <figure class="image pt_115 d-lg-none">
                                <img src="assets/images/resource/entreprise.jpg" alt="" class="img-fluid" style="width:100%;max-width:300px;height:300px;object-fit:cover;border-radius:50%;">
                            </figure>
    ...
    <section class="service-style-two pb_120">
        ...
        <div class="auto-container">
            <div class="sec-title centred mb_70">
                {{-- <h6>Nos Services</h6> --}}
                <h3>Les produits et services de l'entreprise</h3>
            </div>
            <div class="tabs-box ">
                <div class="tab-btn-box p_relative mb_100">
                    <ul class="tab-btns tab-buttons">
                        ...
                        <li class="tab-btn" data-tab="#tab-3"><span>Engagements par signature</span></li>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                <div class="content_block_four">
                                    <div class="content-box mr_110">
                                        ...
                                        <p>A Pacific Finance, nous nous engageons à soulager la trésorerie de nos clients en nous substituant à eux en cas de défaillance dans l’exécution des prestations de travaux et de services publics ou privés à travers la délivrance de </p>
                                        <ul class="list-item mb_40 clearfix">
                                            <li>Caution de soumission </li>
                                            <li>Caution de bonne fin </li>
                                            <li>Caution de parfait achèvement</li>
                                            <li>Caution d’avance de démarrage </li>
                                            <li>Attestation capacité financière </li>
                                        </ul>
                                        <a href="{{ route('Engagements') }}" class="theme-btn btn-one">Découvrez encore plus</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                <div class="image-box ml_40">
                                    <div class="image-shape" style="background-image: url(assets/images/shape/shape-3.png);"></div>
                                    <figure class="image"><img src="assets/images/resource/signature.jpg" alt="" style="width:500px;height:500px;object-fit:cover;"></figure>
                                </div>
                            </div>
                        </div>
                    </div>
