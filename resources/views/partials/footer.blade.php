...
<footer class="main-footer">
    <div class="widget-section">
        <div class="pattern-layer">
            <div class="pattern-1" style="background-image: url('{{ asset('assets/images/shape/shape-8.png') }}');"></div>
            <div class="pattern-2" style="background-image: url('{{ asset('assets/images/shape/shape-9.png') }}');"></div>
        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                    <div class="footer-widget logo-widget">
                        <figure class="footer-logo">
                            <a href="index.html"><img src="{{ asset('assets/images/banner/logo (5).jpg') }}" alt="" style="object-fit: cover;width:100px;height:100px;"></a>
                        </figure>
    ...
    <div class="footer-bottom centred">
        <div class="auto-container">
            <div class="copyright">
                <p>Copyright 2024 par <a href="index.html">Pacific-finance</a>. Tous droits réservés.</p>
            </div>
        </div>
    </div>
</footer>
