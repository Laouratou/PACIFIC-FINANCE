<div class="header">
    <div class="header-left active">
        ...
        <a href="{{ url('index.html') }}" class="logo-small">
            <img src="{{ asset('img/logo-small.png') }}" alt="Small Logo">
        </a>
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow flag-nav">
            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);" role="button">
                <img src="{{ asset('img/flags/us1.png') }}" alt="English" height="20">
            </a>
            <div class="dropdown-menu dropdown-menu-right">
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('img/flags/us.png') }}" alt="English" height="16"> English
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('img/flags/fr.png') }}" alt="French" height="16"> French
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('img/flags/es.png') }}" alt="Spanish" height="16"> Spanish
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('img/flags/de.png') }}" alt="German" height="16"> German
                </a>
            </div>
        </li>
        ...
        <li class="nav-item dropdown">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <img src="{{ asset('img/icons/notification-bing.svg') }}" alt="Notifications">
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            ...
            <div class="dropdown-menu menu-drop-user">
                <div class="profilename">
                    ...
                    <hr class="m-0">
                    <a class="dropdown-item logout pb-0" href="signin.html"><img src="{{ asset('assets/img/icons/log-out.svg') }}" class="me-2" alt="Logout">Logout</a>
                </div>
            </div>
        </li>
    </ul>
